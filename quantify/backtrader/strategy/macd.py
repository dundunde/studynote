...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        if self.data_2 is not None:
            ...
            self.cross_2 = bt.indicators.CrossOver(
                self.macd_2.macd, self.macd_2.signal
            )
        else:
            self.macd_2 = None
            self.cross_2 = None
    ...
    def next(self):
        ...
        target_stake = self.getsizer().p.stake
        ...
        #     if self.cross_2[0] > 0:
        #         self.order = self.order_target_size(data=self.data_2,target=target_stake)
        #     if self.cross_2[0] < 0:
        #         self.order = self.order_target_size(data=self.data_2,target=-target_stake)
